...
Процедура ЛогВыводКомандыИзФайла(ИмяФайлаВывода) Экспорт
	...
	УдалитьФайлПоВозможности(ИмяФайлаВывода);
...
Функция ВыполнитьКоманду(Знач ЛокальныйРепозиторийАдрес,
	...
	УдалитьФайлПоВозможности(командныйФайл);
...
Процедура УдалитьФайлПоВозможности(ИмяФайла) Экспорт 
	
	Попытка
		УдалитьФайлы(ИмяФайла);
	Исключение
		ЛогОшибка("Не удалось удалить файл:"""+ИмяФайла+"""."+Символы.ПС + ОписаниеОшибки());
	КонецПопытки;
